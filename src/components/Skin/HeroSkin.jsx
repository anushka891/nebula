...
function HeroSkin() {
  return (
    <div className="bg-[#494336] overflow-x-hidden">
      <div className="max-w-[1340px] ml-auto 2xl:mx-auto flex-col-reverse xl:flex-row flex items-end pr-8 sm:pr-10 lg:pr-12 xl:pr-0 justify-center xl:justify-end pl-8 sm:pl-10 lg:pl-12 gap-0 md:gap-16 xl:gap-[100px]">
        <div
        ...
        <div className="max-w-[240px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[450px] xl:max-w-[513px] mr-[-48px] xl:mr-0 xl:ml-0 pt-4 pb-0 lg:py-8">
