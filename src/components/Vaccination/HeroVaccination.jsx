...
import hero from "./../../assests/img/png/vccination-main-icon.png";
import SubChild from "../common/SubChild";
function HeroVaccination() {
  return (
    <div className="bg-[#494336]">
      <div className="max-w-[1340px] ml-auto mr-0 2xl:mx-auto flex-col-reverse xl:flex-row flex items-end pr-8 sm:pr-10 lg:pr-12 xl:pr-0 justify-center xl:justify-end pl-8 sm:pl-10 lg:pl-12 gap-0 md:gap-11 overflow-x-hidden">
        ...
        <div
          ...
          className="max-w-[300px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[450px] xl:max-w-[550px] mt-2 mr-[-50px] ml-0"
        >
